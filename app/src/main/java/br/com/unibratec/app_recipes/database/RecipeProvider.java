...
public class RecipeProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "br.com.unibratec.recipes";

    // BASE_URI   = "content://" + AUTHORITY +"/"+ PATH
    public static Uri BASE_URI = Uri.parse("content://"+ AUTHORITY);

    // RECIPES_URI = "content://" + AUTHORITY +"/"+ PATH +"/recipes"
    ...
    // GENERICA, usada no insert e query   = content://br.com.unibratec.recipes/recipes
    // POR ID, usada no delete e query = content://br.com.unibratec.recipes/recipes/{id_recipe}
